...
ISO-8859 mapping files are from `ftp://ftp.unicode.org/Public/MAPPINGS/ISO8859/`. Move the appropriate text files into `Mappings/`, and check the references in `Mappings/mappings.txt`.
